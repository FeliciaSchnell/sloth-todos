<template>
  <div class="taskList">
    ...
    <div class="listItem" v-for="(item, index) in data" :key="index">
      ...
      <svg height="24" width="24" viewBox="0 0 24 24" class="deleteIcon" title="Delete task" @click="$emit('taskDelete')"><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z" fill="#000"/></svg>
    </div>
  </div>
</template>
